...
class Solution {
    int doOverlap(int L1[], int R1[], int L2[], int R2[]) {
        ...
        // When rectangles are either 
        //left aside or right aside to each other 
        //then the are not overlapping at all
        if(L2[0] > R1[0] || L1[0] > R2[0])
            return 0;
        
        
        // When rectangles are either upwards or downwards to each other
        // then the are not overlapping at all
